# Frontend brief (historical)

> This is the original brief the frontend was generated from, kept for
> reference. It predates [specs.md](specs.md), which is the current authority on
> product scope. Where the two disagree, specs.md wins.
...
The application has since moved into [frontend/](../frontend/) and is managed
with bun. See the [root README](../README.md) for how to run it.
